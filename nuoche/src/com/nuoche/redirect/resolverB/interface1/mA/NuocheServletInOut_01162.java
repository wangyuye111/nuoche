...
public class NuocheServletInOut_01162  extends HttpServlet {

	
	private static final long serialVersionUID = -1204545408335287565L;


	public NuocheServletInOut_01162() {
		super();
	}
...
//		arg = JsonUtil.jsonReceive(request);
		...
		try {
			...
			/*case "A-user-add":
				inOutFace = new NuocheInoutUser_01162(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
				inOutFace = new NuocheInoutUser_01162(arg, request, response);
			...
			case "A-boss-add":
				inOutFace = new NuocheInoutBoss_01162(arg, request, response);
				inOutFace.addface();
				break;
			case "A-boss-delete":
				inOutFace = new NuocheInoutBoss_01162(arg, request, response);
