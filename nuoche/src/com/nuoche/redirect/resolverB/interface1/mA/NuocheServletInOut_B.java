...
@WebServlet("/uiface/member")
public class NuocheServletInOut_B  extends HttpServlet {

	
	private static final long serialVersionUID = -1204545408335287565L;


	public NuocheServletInOut_B() {
		super();
	}
...
//		arg = JsonUtil.jsonReceive(request);
		...
		try {
			...
			case "A-user-add":
				inOutFace = new NuocheInoutUser_B(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
				inOutFace = new NuocheInoutUser_B(arg, request, response);
