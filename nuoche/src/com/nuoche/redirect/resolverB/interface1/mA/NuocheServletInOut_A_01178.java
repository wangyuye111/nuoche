...
import com.nuoche.classroot.interface4.ThumbImage;




@WebServlet("/uiface/arr")
public class NuocheServletInOut_A_01178  extends HttpServlet {

	
	private static final long serialVersionUID = -1204545408335287565L;


	public NuocheServletInOut_A_01178() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,
		...
		log.send(DataType.specialType, "01178_____", "vliaoServletInOut_01178_arg:", arg);
...
//		arg = JsonUtil.jsonReceive(request);
		...
		try {
			...
			/*case "A-user-add":
				inOutFace = new NuocheInoutUser_A_01178(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
				inOutFace = new NuocheInoutUser_A_01178(arg, request, response);
			...
			case "A-user-delete":
				...
				break;*/
			case "A-boss-add":
				log.send(DataType.specialType, "01178_____", "A-boos-add", arg);
				inOutFace = new NuocheInoutBoos_A_01178(arg, request, response);
				inOutFace.addface();
				break;
			case "A-boss-mod":
				log.send(DataType.specialType, "01178_____", "A-boos-mod", arg);
				inOutFace = new NuocheInoutBoos_A_01178(arg, request, response);
				inOutFace.modface();
				break;
			case "A-boss-search":
				log.send(DataType.specialType, "01178_____", "A-boos-search", arg);
				inOutFace =new NuocheInoutBoos_A_01178(arg, request, response);
				inOutFace.searchface();
				break;
			case "A-boss-delete":
				log.send(DataType.specialType, "01178_____", "A-boos-delete", arg);
				inOutFace=new NuocheInoutBoos_A_01178(arg, request, response);
			    inOutFace.deleteface();
				break;
