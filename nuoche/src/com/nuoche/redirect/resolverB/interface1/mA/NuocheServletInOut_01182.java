...
@WebServlet("/uiface/nc")
public class NuocheServletInOut_01182  extends HttpServlet {

	
	private static final long serialVersionUID = -1204545408335287565L;


	public NuocheServletInOut_01182() {
		super();
	}
...
//		arg = JsonUtil.jsonReceive(request);
		...
		try {
			...
			case "A-user-add":
				inOutFace = new NuocheInoutUser_01182(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
				inOutFace = new NuocheInoutUser_01182(arg, request, response);
