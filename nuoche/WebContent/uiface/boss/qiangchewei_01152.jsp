...
<nav class="breadcrumb">
	...
	<span class="c-gray en">&gt;</span> 抢车位明细
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="80">用户id</th>
				<th width="80">用户昵称</th>
				<th width="80">抢车位用户id</th>
				<th width="80">抢车位用户昵称</th>
				<th width="80">抢车位时间</th>
				<th width="80">车位价格</th>
				<th width="80">付款状态</th>
		...
		<%-- <tr>
		<td colspan="8">当页明细金额:${nodeValue}</td>
		</tr> --%>
		</tbody>
	</table>
...
function fresh_page(pageIndex) {
	...
	$.ajax({
		...
		<%-- url:"<%=path%>/rp?p0=A-boss-search&p1=cash_withdrawal&p2="+pageIndex+"&p3="+startdate+"&p4="+enddate+"&p5=tojson&p6="+pp+"&p7=0", --%>
				//qiangcheweimingxi
		url:"<%=path%>/xnc?p0=A-boss-search&p1=qiangcheweimingxi&p2="+pageIndex+"&p3="+startdate+"&p4="+enddate+"&p5=tojson&p6="+pp+"&p7=0",
		async: true,
