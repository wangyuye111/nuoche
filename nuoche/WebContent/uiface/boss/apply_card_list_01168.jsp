...
<nav class="breadcrumb">
	...
	<span class="c-gray en">&gt;</span> 挪车卡列表 
...
function fresh_page(pageIndex){
	...
	$.ajax({
		...
		url:"<%=path%>/ar?p0=A-boss-search&p1=apply_card&p2="+pageIndex+"&p3=tojson&p4="+searchtxt,
		async: true,
			   ...
			   /* var online="";
				...
				<td>${map['mail_status']}</td> */
				 ...
				 content +='<tr class="text-c">'
					...
					+'<td>'+json[i].number+'</td>'
					/* +'<td>'+json[i].is_mail+'</td>'  */
					+'<td>'+json[i].mail_status+'</td>'; 
			}
