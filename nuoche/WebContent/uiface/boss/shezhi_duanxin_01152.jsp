				...
				<table
				   ...
				   <th width="30">内容</th> 
					...
					<tbody id="list-content">
							<tr class="text-c">
								<td>1</td>
								<td>${reList[0]['content1']}</td>
								<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/xnc?p0=A-boss-search&p1=duanxin_seach_a','','600','510')"
							...
							<tr class="text-c">
								<td>2</td>
								<td>${reList[0]['content2']}</td>
								<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/xnc?p0=A-boss-search&p1=duanxin_seach_b','','600','510')"
									class="ml-5" style="text-decoration: none"><i
										class="Hui-iconfont">&#xe6df;</i></a>
								</td>
							</tr>
							<tr class="text-c">
								<td>3</td>
								<td>${reList[0]['content3']}</td>
								<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/xnc?p0=A-boss-search&p1=duanxin_seach_c','','600','510')"
									class="ml-5" style="text-decoration: none"><i
										class="Hui-iconfont">&#xe6df;</i></a>
								</td>
							</tr>
							<tr class="text-c">
								<td>4</td>
								<td>${reList[0]['content4']}</td>
								<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/xnc?p0=A-boss-search&p1=duanxin_seach_d','','600','510')"
									class="ml-5" style="text-decoration: none"><i
										class="Hui-iconfont">&#xe6df;</i></a>
								</td>
							</tr>						
