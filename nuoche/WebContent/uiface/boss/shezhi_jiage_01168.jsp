				   ...
				   <th width="30">标题</th> 
					...
					<tbody id="list-content">
							<tr class="text-c">
								<td>1</td>
								 <td>挪车卡价格</td>
								<td>${reList[0]['card_price']}</td>
								<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/ar?p0=A-boss-search&p1=jiage_seach_a','','600','510')"
							...
							<tr class="text-c">
								<td>2</td>
								 <td>红包钱数</td>
								<td>${reList[0]['red_packet']}</td>
								<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/ar?p0=A-boss-search&p1=jiage_seach_b','','600','510')"
									class="ml-5" style="text-decoration: none"><i
										class="Hui-iconfont">&#xe6df;</i></a>
								</td>
							</tr>
							<tr class="text-c">
								<td>3</td>
								 <td>代理价格</td>
								<td>${reList[0]['agency_price']}</td>
								<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/ar?p0=A-boss-search&p1=jiage_seach_c','','600','510')"
									class="ml-5" style="text-decoration: none"><i
										class="Hui-iconfont">&#xe6df;</i></a>
								</td>
							</tr>								
