...
<body>
	<article class="page-container">
		<form action="<%=path%>/xnc?a=A-boss-mod&b=mod_duanxin&c=2" method="post"
			class="form form-horizontal" id="form-article-add" name="ThisForm">
		
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">短信修改:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['content3']}" placeholder="请输入内容" 
