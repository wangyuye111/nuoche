...
<body>
	<article class="page-container">
		<form action="<%=path%>/ar?a=A-boss-mod&b=card_mod&c=2" method="post"
			class="form form-horizontal" id="form-article-add" name="ThisForm">
		
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">代理价格:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['agency_price']}" placeholder="请输入内容" 
