...
<body>
	...
	<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span> 发单抢单时间设置
				...
				<table
					...
					<tbody id="list-content">
							<tr class="text-c">
								<td>1</td>
								<td>抢单时间</td>
								<td>${reList[0]['rush_time']}</td>
								<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/arr?p0=A-boss-search&p1=shijian_search&p2=rushtime','','600','510')"
							...
							<tr class="text-c">
								<td>2</td>
								<td>发单时间</td>
								<td>${reList[0]['send_time']}</td>
								<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/arr?p0=A-boss-search&p1=shijian_search&p2=sendtime','','600','510')"
									class="ml-5" style="text-decoration: none"><i
									class="Hui-iconfont">&#xe6df;</i></a>
								</td>
							</tr>	
