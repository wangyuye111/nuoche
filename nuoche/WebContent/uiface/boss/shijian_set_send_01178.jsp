...
<body>
	...
	<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span> 编辑时间
	...
	<article class="page-container">
		<form action="<%=path%>/arr?a=A-boss-mod&b=time_slot&c=1&d=sendtime" method="post"
			class="form form-horizontal" id="form-article-add" name="ThisForm">
		
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">发单时间:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['time']}" placeholder="请输入时间" 
