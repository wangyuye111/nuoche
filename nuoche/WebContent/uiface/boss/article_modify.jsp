...
<article class="page-container">
	<form method="post"
	action="<%=path%>/JyServletInOut?a=A-boss-mod&b=ArticleMove" 
	 ...
	 class="form form-horizontal" id="form-article-add"    name="ThisForm"   enctype="multipart/form-data"   >
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${reList[0]['name']}" placeholder="请输入广告标题" id="articlename" name="articlename">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					...
					<div><img  src="<%=path %>/../${reList[0]['img']}" width="100px"></div>
					<input type="file" id="fileimg"   />
					<input type="hidden" name="imgname" id="imges" value="${reList[0]['img']}"/>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="articletype" class="select">
				    <option value="${reList[0]['type']}">${reList[0]['type']}</option>
	        ...
	        <div class="row cl"  id="artcontent" >
				...
				<div class="formControls col-xs-8 col-sm-9"> 
					...
					<textarea cols="170" id="descs" name="descs"   >${reList[0]['referral']}</textarea>
